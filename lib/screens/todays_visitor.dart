...
class TodaysVisitor extends StatefulWidget {
  static const screenID = 'Todays Visitor';
  @override
  _TodaysVisitorState createState() => _TodaysVisitorState();
}

class _TodaysVisitorState extends State<TodaysVisitor> {
  @override
  void initState() {
    super.initState();
  }
